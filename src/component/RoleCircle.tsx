...
const RoleCircle = ({ role, onRoleClick, i, n }) => (
  <div
    style={{ top: `${positionX(i, n,256,120)}px`, left: ` ${positionY(i, n,256,120)}px` }}
    className={role.isActive ? "active  role-circl" : " role-circl"}
    onClick={() => onRoleClick(role)}
  >
   
    <div className="name" style={{ top: `${positionX(i, n,140,0)}px`, left: ` ${positionY(i, n,140, 0)}px` }} >{role.name}</div>
  </div>
);
